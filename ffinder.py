...
st.siderbar.write(get_balance(w3, account.address))
...
wage = canidate_database[person][3] = hours

# @TODO
# Write the `wage` calculation to the Streamlit sidebar
st.siderbar.write(wage)
...
if st.sidebar.button("Send Transaction"):
    ...
    transaction_hash = send_transaction(w3, account, canidate_address, wage)
